...
if (($_POST["hs3"].$_POST["gs3"])) {
    echo "<table style='text-align: left; width: 500px;' border=0 cellspacing=0 cellpadding=0><tr><td>Aanvang</td><td>Huidige Score:</td><td>$hs3</td><td>Gewenste Score:</td><td>$gs3</td></tr></table><br>";    
}
...
if (($_POST["hs5"].$_POST["gs5"])) {
    echo "<table style='text-align: left; width: 500px;' border=0 cellspacing=0 cellpadding=0><tr><td>Argumenteren</td><td>Huidige Score:</td><td>$hs5</td><td>Gewenste Score:</td><td>$gs5</td></tr></table><br>";    
}

if (($_POST["hs6"].$_POST["gs6"])) {
    echo "<table style='text-align: left; width: 500px;' border=0 cellspacing=0 cellpadding=0><tr><td>Afsluiten</td><td>Huidige Score:</td><td>$hs6</td><td>Gewenste Score:</td><td>$gs6</td></tr></table><br>";    
}
	?>